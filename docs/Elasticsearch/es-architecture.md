...
![es-index-type-mapping-document-field](/docs/Elasticsearch/images/es-index-type-mapping-document-field.png)
...
![es-cluster](/docs/Elasticsearch/images/es-cluster.png)
